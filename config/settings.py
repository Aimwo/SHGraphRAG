...
DATASET_DIR = BASE_DIR / 'dataset/musique/musique_ans_dev.parquet'
...
CHUNK_LABEL = "__Chunk__"
DOCUMENT_LABEL = "__Document__"
ENTITY_EMBED_FIELD = "embedding"
CHUNK_EMBED_FIELD = "embedding"
TOP_K = 3
